...
func TestLoadBalancerCerticateBundlesAndFrontendTLSConfigs(t *testing.T) {
	...
	record(t, "loadbalancercerticatebundlesandfrontendtlsconfigs", func(t *testing.T, r *recorder.Recorder, svc *Service) {
		...
		mc, err := svc.CreateLoadManualBalancerCertificateBundle(&request.CreateLoadBalancerManualCertificateBundleRequest{
		...
		mc, err = svc.ModifyLoadBalancerManualCertificateBundle(&request.ModifyLoadBalancerManualCertificateBundleRequest{
			UUID: mc.UUID,
		...
		dc, err = svc.ModifyLoadBalancerDynamicCertificateBundle(&request.ModifyLoadBalancerDynamicCertificateBundleRequest{
			UUID: dc.UUID,
