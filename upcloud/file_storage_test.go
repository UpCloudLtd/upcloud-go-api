	...
	cases := []FileStorage{
		{
			...
			Networks:         []FileStorageNetwork{{UUID: "net-uuid", Name: "net1", Family: "IPv4", IP: "192.168.1.1"}},
			Shares:           []FileStorageShare{{Name: "share1", Path: "/mnt/share1", ACL: []FileStorageACL{{Target: "user", Permission: "rw"}}}},
