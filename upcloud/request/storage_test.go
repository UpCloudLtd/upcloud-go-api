...
// TestResizeStorageFilesystemRequest tests that ResizeStorageFilesystemRequest objects behave correctly
func TestResizeStorageFilesystemRequest(t *testing.T) {
	request := ResizeStorageFilesystemRequest{
		UUID: "foo",
	}
